  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t('quick.threads_title', 'Threads')}</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          <MaterialIcons name="forum" size={48} color={colors.border} />
          <Text style={styles.emptyText}>{t('quick.no_threads')}</Text>
          <Text style={styles.emptySub}>{t('quick.no_threads_sub')}</Text>
        </View>
      ) : (
        <FlatList
