...
const translations = {
  en: {
    ...
    noSavedDesc: "You haven't saved any messages yet. Click the bookmark icon on a message to save it for later.",
    savedFrom: 'Saved from',
    loadingThreads: 'Loading threads...',
    noThreads: 'No threads yet',
    noThreadsDesc: 'When you reply to a message or are mentioned in a thread, it will appear here.',
  ...
  ar: {
    ...
    noSavedDesc: 'لم تقم بحفظ أي رسائل بعد. اضغط على أيقونة الحفظ على أي رسالة لتجدها هنا.',
    savedFrom: 'محفوظة من',
    loadingThreads: 'جاري تحميل المحادثات...',
    noThreads: 'لا توجد محادثات متسلسلة بعد',
    noThreadsDesc: 'عند الرد على رسالة أو الإشارة إليك في محادثة، ستظهر هنا.',
    repliedIn: 'تم الرد في',
    searchResultsFor: 'نتائج البحث عن',
    searching: 'جاري البحث...',
    noResults: 'لم يتم العثور على نتائج',
    tryAdjusting: 'حاول تغيير كلمات البحث.',
    postedIn: 'نُشرت في',
    // Channels
